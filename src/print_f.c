...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/07 22:53:31 by pparalax          #+#    #+#             */
/*   Updated: 2019/10/07 22:53:35 by pparalax         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** --------------------------
**	implements itoa to number and copy result to string and
**	clears all temp vars.
**
...
** --------------------------
**	prints float and long float, both are 32-bit.
**	Integer part transform to string using itoa, the float part transform by
**	multiplying by 10 till  get precision
...
**	--------------------------
**	prints double as long long float which is 64-bit length.
**	Integer part transform to string using itoa, the float part transform by
**	multiplying by 10 till  get  necessary precision
**	given in g_flag->cut or 6 digits if g_flag->cut = 0
**
